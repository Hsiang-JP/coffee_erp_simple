...
const DataManagement = () => {
  ...
  useEffect(() => {
    async function loadAll() {
      ...
      loadTable('bags', "SELECT b.*, l.public_id as lot_public_id, c.public_id as contract_public_id FROM bags b JOIN lots l ON b.lot_id = l.id LEFT JOIN contracts c ON b.allocated_contract_id = c.id");
      ...
      loadTable('bag_milestones', "SELECT bm.*, b.public_id as bag_public_id, c.public_id as contract_public_id FROM bag_milestones bm JOIN bags b ON bm.bag_id = b.id LEFT JOIN contracts c ON b.allocated_contract_id = c.id");
    }
    loadAll();
  }, [refreshTrigger]);
